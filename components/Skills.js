...
function Skills() {
  return (
    <>
      <div id="section2" className="Container-Skills h-screen w-auto bg-customm snap-start ">
        <div className="Skills-container h-2/5 flex flex-col " data-aos="fade-up">
          <h1 className="font-black font-mono text-yellow-50 text-4xl ml-auto mr-auto pt-16 pb-16">
            Professional <span className="text-teal-400 font-sans font-bold">Skillset</span>
          </h1>

          <div className="Skills flex flex-wrap justify-center pl-36 pr-44">
              ...
              </div><div className="p-4 w-1/2 md:w-1/4">
              ...
              <div className="p-4 w-1/2 md:w-1/4 pb-5">
